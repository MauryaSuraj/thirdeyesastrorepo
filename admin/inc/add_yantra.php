...
<div class="blank-page widget-shadow scroll" id="style-2 div1">
  ...
  if (isset($_POST['add_yantra'])) {
    ...
    if (add_yantra_dettails($_POST['yantra_name'], $_POST['yantra_details'], $_POST['yantra_price'], $_POST['yantra_meta_keywords'], $_POST['yantra_meta_description'], $upload_1, $upload_2, $upload_3)) {
