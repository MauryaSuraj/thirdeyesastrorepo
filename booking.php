    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="row">
          ...
          if (isset($_POST['complete_purchase'])) {
            ...
            if (booking_with_product($email, $_POST['samagri_id'] ,$_POST['booking_date'], $_POST['booking_time'], $_POST['address'], $_POST['address_proof'], $upload_2, $_GET['product_type'], $_GET['product_id'])) {
                  $message = "<div class='alert alert-success'> Your Booking Is completed </div>";
            }else {
      ...
      <div class="col-md-4 p-1">
        <div class="row">
          <div class="col-md-12">
            <?php echo $message;  ?>
            <form class="z-depth-3 p-4 mt-2   border-rounded" method="post" enctype="multipart/form-data">
              <fieldset class="form-group text-center">
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="1" name="samagri_id">
                  <label class="form-check-label" for="inlineCheckbox1"><strong>Samagri include</strong></label>
                </div>
              </fieldset>
              ...
              <fieldset class="form-group">
                <label for="exampleInputEmail1"> <strong> Select Booking Date  </strong> </label>
                <input type="date" class="form-control"  name="booking_date">
              </fieldset>
              <fieldset class="form-group">
                <label for="exampleInputEmail1"> <strong> Select Booking Time  </strong> </label>
                <input type="number" min="00" max="24" step="1" class="form-control" name="booking_time" value="00">
              </fieldset>
              <fieldset class="form-group">
              ...
              <button type="submit" class="btn btn-primary" name="complete_purchase"> Complete Booking </button>
            </form>
          </div>
        </div>
      </div>
